...
def rebuild_manifest():
    try:
        ...
        print("🔄 Đã cập nhật audio_manifest.json thành công!")
...
def main():
    ...
    # 1. Row Bài Đọc 1 cho Thứ Hai Tuần XVII Thường Niên (Năm II / 2026) - ID: 9a39ab93-71a9-49ce-819a-bf0e4270fd1d
    r1_row = None
    # 2. Row Tin Mừng cho Thứ Hai Tuần XVII Thường Niên - ID: 67320504-542d-41b0-ac32-01cdcd5b19f2
    gospel_row = None

    for r in rows:
        if r.get("id") == "9a39ab93-71a9-49ce-819a-bf0e4270fd1d":
            r1_row = r
        elif r.get("id") == "67320504-542d-41b0-ac32-01cdcd5b19f2":
            gospel_row = r

    if not r1_row or not gospel_row:
        print("❌ Không tìm thấy dữ liệu Phụng Vụ cho ngày 27/7/2026!")
        sys.exit(1)

    print("===============================================================")
    print("🎙️ BẮT ĐẦU RENDER BÀI ĐỌC PHỤNG VỤ CHO NGÀY MAI 27/07/2026")
    ...
    rebuild_manifest()
    print("\n===============================================================")
    print("🎉 HOÀN THÀNH RENDER TOÀN BỘ BÀI ĐỌC NGÀY MAI 27/07/2026!")
    print("===============================================================")
