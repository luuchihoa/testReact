      ...
      <main className="max-w-4xl mx-auto px-6 pb-20 space-y-16">
        ...
        >
          <motion.div variants={fadeInUp} className="text-center mb-8">
            <p className="text-[11px] font-bold uppercase tracking-widest text-teal-700 mb-2">Bộ nhận diện</p>
            <h2 className="font-serif font-bold text-2xl md:text-3xl text-stone-900">Sắc màu mang ý nghĩa</h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            {MEANING.map((m) => (
              <motion.div
                ...
                variants={fadeInUp}
                whileHover={{ y: -4 }}
                className="bg-white rounded-2xl border border-stone-200/70 shadow-sm p-6 text-center"
              >
                <div className={`w-12 h-12 rounded-full mx-auto mb-4 shadow-sm ${m.swatch}`} />
                <h3 className="font-serif font-bold text-lg text-stone-900 mb-1.5">{m.title}</h3>
