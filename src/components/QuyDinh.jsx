  ...
  const sections = [
    {
      ...
      body: "Nền tảng này được Ban Giáo Lý Giáo xứ An Ngãi xây dựng nhằm hỗ trợ việc học hỏi, ôn tập giáo lý cho các em thiếu nhi và huynh trưởng trong xứ đoàn. Nội dung chỉ phục vụ mục đích giáo dục đức tin.",
    },
    {
      icon: UserCheck,
      heading: "2. Tài khoản người dùng",
      body: "Mỗi tài khoản được cấp cho một cá nhân cụ thể. Người dùng có trách nhiệm bảo mật mật khẩu và không chia sẻ tài khoản cho người khác sử dụng.",
    },
    {
      icon: FileText,
      heading: "3. Quy tắc làm bài kiểm tra",
      body: "Các bài trắc nghiệm và tự luận trên hệ thống được tạo ngẫu nhiên. Học viên cam kết tự làm bài, không tra cứu đáp án hay nhờ người khác làm thay trong thời gian tính giờ.",
    },
    {
      icon: Copyright,
      heading: "4. Nội dung và bản quyền",
      body: "Hình ảnh và tài liệu giáo lý thuộc quyền sử dụng của Ban Giáo Lý Gx. An Ngãi. Vui lòng không sao chép, phát tán lại dưới danh nghĩa cá nhân hoặc tổ chức khác.",
    },
    {
      icon: RefreshCw,
