    ...
    <Backdrop handleClose={handleClose}>
      ...
      >
        <div className="p-6">
          ...
          <p className="text-center text-[12px] font-medium text-stone-500 dark:text-stone-400 mt-5 leading-relaxed select-none">
            Quên mật khẩu? Liên hệ{" "}
            <span className="text-amber-800 dark:text-amber-500 font-semibold cursor-default">
              quản trị viên
            </span>.
          </p>
        </div>
